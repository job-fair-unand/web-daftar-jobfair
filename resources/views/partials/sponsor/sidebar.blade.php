<aside class="w-64 bg-white shadow-lg hidden md:flex md:flex-col sticky top-0 h-screen overflow-y-auto">
    ...
    <nav class="mt-5 px-4 flex-grow">
        <a href="#" 
           class="flex items-center px-4 py-2.5 mt-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors duration-150 {{ request()->routeIs('sponsor.dashboard') ? 'bg-blue-100 text-blue-700 font-semibold' : 'font-medium' }}">
